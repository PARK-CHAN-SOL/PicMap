  ...
  <div class="md-content">
    ...
    <div class="container">
      ...
      <div class="card overflow-hidden">
        <div class="p-0">
          <div>
            <img id="mypageBack" src="/resources/assets/img/mypageback.png" alt="" class="img-fluid">
            <div id="mapWrap" class="map_wrap img-fluid" style=" display:none; height: calc(18vw + 254.54545px);">
          ...
          <div class="row align-items-center">
            <div class="col-lg-4 order-lg-1 order-2">
              <div class="d-flex align-items-center justify-content-around m-4">
                ...
                <div id="followerDiv" class="text-center" data-bs-toggle="modal" data-bs-target="#staticBackdrop" data-to-follow="${param.memberNum}">
                  ...
                  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h1 class="fs-3 text-center" style="width: 1000px; height: px;" id="staticBackdropLabel">팔로워</h1>
                ...
                <!------------------------------------------------------------------------------------------>
                <div id="followingDiv" class="text-center" data-bs-toggle="modal" data-bs-target="#staticBackdrop1" data-from-follow="${param.memberNum}">
                ...
                <div class="modal fade" id="staticBackdrop1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h1 class="fs-3 text-center" style="width: 1000px; height: px;" id="staticBackdropLabel">팔로잉</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>
                      <div class="modal-body">
                        <main id="explore">
                          <div>
                            <ul class="explore__users u-default-box" id="followingList"></ul>
                          </div>
            ...
            <div class="col-lg-4 mt-n3 order-lg-2 order-1">
              <div class="mt-n5">
                <div class="d-flex align-items-center justify-content-center mb-2">
                  <div class="linear-gradient d-flex align-items-center justify-content-center rounded-circle" style="width: 110px; height: 110px; z-index:10;">
                    <div class="border border-4 border-white d-flex align-items-center justify-content-center rounded-circle overflow-hidden" style="width: 100px; height: 100px;">

                      <c:if test="${not empty member.profilePath}">
                        <img id="profileImage" src="${member.profilePath}" onerror="this.src='/resources/upload/members/default.png'" alt="" class="w-100 h-100">
                      </c:if>
                      <c:if test="${empty member.profilePath}">
                        <img id="profileImage" src="/resources/upload/members/default.png" alt="" class="w-100 h-100">
                      </c:if>
                    </div>
                  </div>
              ...
              <ul class="list-unstyled d-flex align-items-center justify-content-center justify-content-lg-start my-3 gap-3">
                <c:if test="${sessionScope.member.memberNum ne member.memberNum}">
                  <c:if test="${followCheck eq 1}">
                    <li>
                      <button class="follow_btn fs-4" type="button" id="follow" data-to-follow="${param.memberNum}">팔로우</button>
                    </li>
                  </c:if>
                  <c:if test="${followCheck eq -1}">
                    <li>
                      <button class="following_btn fs-4" type="button" id="follow" data-to-follow="${param.memberNum}">팔로잉</button>
                    </li>
                  </c:if>
                </c:if>
          ...
          <ul class="nav nav-pills user-profile-tab justify-content-end mt-2 bg-light-info rounded-2" id="pills-tab" role="tablist">
            <li class="nav-item" role="presentation">
              <button class="nav-link position-relative rounded-0 active d-flex align-items-center justify-content-center bg-transparent fs-3 py-6" id="pills-friends-tab" data-bs-toggle="pill" data-bs-target="#pills-friends" type="button" role="tab" aria-controls="pills-friends" aria-selected="false" tabindex="-1">
                        ...
                        <div class="box-image2">
                          <div>
                            <c:if test="${empty dto.fileName}">
                              <a class="box-image2__bg" href="/travel/detail?boardNum=${dto.boardNum}" style="background-image: url('/resources/upload/travels/default.png');"> <!-- <img src="/resources/assets/img/image_box_2/1.jpg" alt="" /> -->
                              </a>
                            </c:if>
                            <c:if test="${not empty dto.fileName}">
                              <a class="box-image2__bg" href="/travel/detail?boardNum=${dto.boardNum}" style="background-image: url('/resources/upload/travels/${dto.fileName}');"> <!-- <img src="/resources/assets/img/image_box_2/1.jpg" alt="" /> -->
                              </a>
                            </c:if>
                            ...
                            <div class="box-image2__info_bot">
                              <span class="box-image2__date">${dto.createDate}</span> <span class="box-image2__like">좋아요</span>
                            </div>
                          </div>
                        </div>
                        <!-- End / box-image2 -->
