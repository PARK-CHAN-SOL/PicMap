...
.modal {
  ...
  z-index: 1; /* 모달이 다른 요소보다 앞에 오도록 설정 */
  left: 50%; /* 화면의 가로 중앙으로 위치 설정 */
  top: 50%; /* 화면의 세로 중앙으로 위치 설정 */
  width: 30%; /* 모달 창 너비 */
  height: 30%; /* 모달 창 높이 */
  transform: translate(-50%, -50%); /* 위치를 정확히 가운데로 맞추기 위해 변환 */
  overflow: auto; /* 필요시 스크롤 추가 */
  background-color:  /* 배경 어둡게 */
}
.modal-content {
						...
						<li class="nav-item" role="presentation">
							<button
								...
								<i class="fa fa-user me-2 fs-6"></i> <span
									class="d-none d-md-block">저장한 게시글</span>
							</button>
						</li>
					</ul>
				</div>
													...
													<div>
														<c:if test="${empty dto.fileName}">
															<a class="box-image2__bg"
																href="/travel/detail?boardNum=${dto.boardNum}"
														...
														<div class="box-image2__info_bot">
															<span class="box-image2__date">${dto.createDate}</span> <span
																class="box-image2__like">좋아요</span>
														</div>
													</div>
												</div>
												<!-- End / box-image2 -->
