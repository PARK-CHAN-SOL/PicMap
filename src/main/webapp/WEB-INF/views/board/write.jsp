            ...
            <table class="table table-bordered">
              <tbody>
                ...
                <tr>
                  ...
                  <th colspan="2"><input type="file" class="form-control fs-4" id="files" name="files" onchange="readURL(this)" style="display:none;"style="display:none;"> <label for="files" class="fs-4 btn btn-secondary">게시글 사진을 추가하세요</label> <img id="preview" class="mt-3" style="width: 100%; height: 100%; object-fit: cover;" /></th>
                </tr>
                <tr>
