...
document.addEventListener("click", (event) => {
    if (event.target.dataset.idHeart != null && event.target.dataset.idHeart != '') {
        ...
        fetch('/heart/noticeClick?boardNum=' + heartButton.getAttribute("data-id-heart"), {
            method: "GET"
        })
...
fetch('/heart/noticeCount?boardNum=' + heartButton.getAttribute("data-id-heart"), { 
    method: "GET"
})
    .then((res) => { return res.json(); })
    .then((res) => {
...
fetch('/heart/noticeCheck?boardNum=' + heartButton.getAttribute("data-id-heart"), { 
    method: "GET"
})
    .then((res) => { return res.json(); })
    .then((res) => {
